...
%***********Basic Settings************
%*************************************
% will use winRec return from 'openWindow' be better?
Param.Settings.ViewDistance   = 725;               % 1100 mm in the scanner 
Param.Settings.ScrnResolution = [0 0 1024 768];   % rect_computer = [0 0 40 30];
Param.Settings.SquareSize     = 1024;  %400        % pixels
Param.Settings.SquareLength   = 400;   %154        % mm 
